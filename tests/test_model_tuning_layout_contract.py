...
def test_candidate_execution_title_uses_ripple_while_running_and_green_dot_when_completed() -> None:
    ...
    assert '@keyframes modelTuningCaroStatusColor {' in styles
    assert '40% { color: #58e6a8; }' in styles
    assert '72% { color: #66a9ff; }' in styles
    assert 'modelTuningCandidateNameRunning' not in styles
